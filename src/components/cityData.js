// export const cities = [
//     // Cada objeto contiene el nombre de la ciudad y una URL de imagen representativa
//     { name: 'Tokyo', image: 'https://tsmnoticias.com/wp-content/uploads/2016/12/Tokio-es-el-destino-asiatico-mas-solicitado-por-los-colombianos-1.jpg' },
//     { name: 'Dubai', image: 'https://www.cloud-europamundo.com/img/carousel/hd/Dubai_20221104170129.jpg' },
//     { name: 'Rome', image: 'https://static.toiimg.com/photo/53891769.cms' },
//     { name: 'Cape Town', image: 'https://www.south-african-hotels.com/media/OneandOnlyHotel.jpg' },
...
//     { name: 'Bangkok', image: 'https://viajes.nationalgeographic.com.es/medio/2023/06/28/gran-palacio-real_491caafe_1385269772_230628145613_1280x854.jpg' },
//     { name: 'Sydney', image: 'https://cdn.britannica.com/86/156586-050-EFB37140/Harbour-Bridge-Sydney.jpg' },
//     { name: 'Moscow', image: 'https://www.after-russia.org/content/explained_regional-disparities-in-russia_moscow.jpg' },
//     { name: 'London', image: 'https://i.pinimg.com/736x/6d/6a/88/6d6a8802a2267e47840be77a470a0dc4.jpg' },
//     { name: 'Rio de Janeiro', image: 'https://www.revistadeck.com/wp-content/uploads/Cristo-Redentor.-Icono-de-Rio-de-Janeiro-y-del-mundo-Portada.jpg' },
//     { name: 'Cairo', image: 'https://www.panavision-tours.com/viajes/el-cairo-turismo/el-cairo.jpg' },
//     { name: 'Oporto', image: 'https://i0.wp.com/www.telocuentoviajando.com/wp-content/uploads/2022/03/IMG_9480-scaled.jpg?fit=2560%2C1707&ssl=1' },
// ];
